...
class FetchTwo extends StatefulWidget {
  const FetchTwo({Key? key}) : super(key: key);

  @override
  _FetchTwoState createState() => _FetchTwoState();
}
...
class _FetchTwoState extends State<FetchTwo> {
  bool isLoading = true;
                                            ...
                                            ElevatedButton(
                                              ...
                                              onPressed: () {
                                                Navigator.push(context,
                                                    ...
                                                    // MaterialPageRoute(builder: (context) => Campaigndetails(campaign: listResponse![index])));
