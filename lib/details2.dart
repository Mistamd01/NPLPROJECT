...
class CampaigndetailsTwo extends StatefulWidget {
  Map<dynamic, dynamic>? campaign;
 CampaigndetailsTwo({Key? key, this.campaign});

  //const Campaigndetails({Key? key}) : super(key: key);

  @override
  _CampaigndetailsTwoState createState() => _CampaigndetailsTwoState();
}
...
class _CampaigndetailsTwoState extends State<CampaigndetailsTwo> {
  bool isLoading = true;
                ...
                leading: IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => FetchThree()));
                    })),
        // body: Center(
        //   child: Container(
        //     height: 200,
                    ...
                    child:  Column(
                      ...
                      children: <Widget>[
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(context,
                                MaterialPageRoute(builder: (context) => DonateThree(campaign: widget.campaign)));
